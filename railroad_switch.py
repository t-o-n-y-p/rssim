...
class RailroadSwitch(GameObject):
    ...
    def read_state(self):
        ...
        if os.path.exists('user_cfg/switches/switch_{}_{}_{}.ini'.format(self.straight_track,
                                                                         self.side_track,
                                                                         self.direction)):
            self.config.read('user_cfg/switches/switch_{}_{}_{}.ini'.format(self.straight_track,
                                                                            self.side_track,
                                                                            self.direction))
        else:
            self.config.read('default_cfg/switches/switch_{}_{}_{}.ini'.format(self.straight_track,
                                                                               self.side_track,
                                                                               self.direction))
    ...
    def save_state(self):
        ...
        with open('user_cfg/switches/switch_{}_{}_{}.ini'.format(
