...
class MainFrame(GameObject):
    def __init__(self, batch, main_frame_group, game_config):
        ...
        self.main_frame = pyglet.image.load('img/main_frame/main_frame_{}_{}.png'
                                            .format(self.c.screen_resolution[0],
                                                    self.c.screen_resolution[1]))
        self.main_frame_sprite = pyglet.sprite.Sprite(self.main_frame, x=0, y=0, batch=batch, group=main_frame_group)
