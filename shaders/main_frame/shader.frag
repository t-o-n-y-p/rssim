...
void main()
{
    ...
    if (schedule_opacity > 0)
    {
        ...
        vec2 top_left_cell = vec2(cell_height, screen_resolution[1] - 33 - int(float(screen_resolution[1] - 110 - 4 * cell_height - 3 * interval_between_cells_height + int(0.025 * float(screen_resolution[0])) + int(0.01171875 * float(screen_resolution[0]))) / 2.0));
