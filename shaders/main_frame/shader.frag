...
void main()
{
    ...
    if (gl_FragCoord[0] >= 2 && gl_FragCoord[0] <= screen_resolution[0] - 3
        && gl_FragCoord[1] >= screen_resolution[1] - top_bar_height + 2 && gl_FragCoord[1] <= screen_resolution[1] - 3
       )
    {
        int margin = screen_resolution[0] - int(gl_FragCoord[0]);
        if (margin == top_bar_height || margin == top_bar_height - 1
       ...
       )
    {
        ...
        if (game_frame_opacity > 0)
        {
            ...
            else if (gl_FragCoord[1] >= 2 && gl_FragCoord[1] <= bottom_bar_height - 3)
            {
                ...
                if (gl_FragCoord[0] == bottom_bar_height - 1 || gl_FragCoord[0] == bottom_bar_height - 2
                    || margin == bottom_bar_height || margin == bottom_bar_height - 1
                    || margin == game_time_margin + 1 || margin == game_time_margin + 2
                    || margin == game_time_margin + bottom_bar_height
        ...
        {
            int margin = screen_resolution[0] - int(gl_FragCoord[0]);
            if (margin == bottom_bar_height || margin == bottom_bar_height - 1
       ...
       )
    {
        ...
        if (mini_map_opacity > 0)
        {
            ...
            if (((gl_FragCoord[0] == mini_map_position[0]
            ...
            if (((gl_FragCoord[0] - mini_map_position[0] == margin_left
        ...
        if (settings_is_activated == 1)
        {
            ...
            if (((settings_decrement_x_margin == 0 || settings_decrement_x_margin == 1
        ...
        if (schedule_opacity > 0)
        {
            ...
            if (gl_FragCoord[1] == top_left_cell[1] || gl_FragCoord[1] == top_left_cell[1] - 1)
            {
                if (gl_FragCoord[0] >= top_left_cell[0] && gl_FragCoord[0] <= top_left_cell[0] + cell_width - 1)
                {
                    ...
                    schedule_coeff = (255.0 - abs(int(gradient_coeff * gradient_coeff * gradient_coeff * 255.0)))
                    / 255.0;
        ...
        if (constructor_opacity > 0)
        {
            ...
            for (int i = 0; i < 4; ++i)
            {
                int y_offset = top_left_cell[1] - i * (cell_height + interval_between_cells_height)
                - int(gl_FragCoord[1]);
                ...
                if (gl_FragCoord[1] >= top_left_cell[1] - i * (cell_height + interval_between_cells_height)
                    - (cell_height - 1)
                    && gl_FragCoord[1] <= top_left_cell[1] - i * (cell_height + interval_between_cells_height)
                    && (x_left_offset == 0 || x_left_offset == 1 || x_left_offset == cell_width - 1
                        || x_left_offset == cell_width - 2
                        || (track_build_button_is_activated == 1 && i == 0
                            && (x_left_offset == cell_width - cell_height
                                || x_left_offset == cell_width - cell_height + 1
                               )
                           )
                        || x_right_offset == 0 || x_right_offset == 1 || x_right_offset == cell_width - 1
                        || x_right_offset == cell_width - 2
                       )
                   )
                {
                    ++is_on_cell_border;
