...
uniform int is_button_activated[22];
uniform int button_x[22];
uniform int button_y[22];
uniform int button_w[22];
uniform int button_h[22];
uniform int number_of_buttons = 22;
