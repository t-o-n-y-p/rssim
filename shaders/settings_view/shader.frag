...
uniform int is_button_activated[18];
uniform int button_x[18];
uniform int button_y[18];
uniform int button_w[18];
uniform int button_h[18];
uniform int number_of_buttons = 18;
