...
uniform int is_button_activated[24];
uniform int button_x[24];
uniform int button_y[24];
uniform int button_w[24];
uniform int button_h[24];
uniform int number_of_buttons = 24;
