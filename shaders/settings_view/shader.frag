...
uniform int is_button_activated[20];
uniform int button_x[20];
uniform int button_y[20];
uniform int button_w[20];
uniform int button_h[20];
uniform int number_of_buttons = 20;
