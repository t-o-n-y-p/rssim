...
bool is_highlighted(int margin_x, int margin_y, int bottom_bar_height, int top_bar_height) {
    return margin_x >= page_viewport_size[0] / 2 - top_bar_height + 2
        && margin_x <= page_viewport_size[0] / 2 - top_bar_height + bottom_bar_height - 2
        && margin_y >= page_viewport_size[1] - 3 * top_bar_height / 2 - bottom_bar_height + 2
        && margin_y <= page_viewport_size[1] - 3 * top_bar_height / 2 - 2;
}
