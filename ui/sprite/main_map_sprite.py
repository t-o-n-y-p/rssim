...
from ui import get_map_tracks, MAP_HEIGHT, GROUPS, BATCHES
...
class MainMapSprite(MapSprite):
    def __init__(self, map_id, parent_viewport):
        super().__init__(
            map_id, logger=getLogger(f'root.app.game.map.{map_id}.main_map_sprite'), parent_viewport=parent_viewport
        )
