...
@final
class EnvironmentRequiredLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.environment_required_label'),
                         i18n_resources_key='unlock_condition_from_environment_track_description_string',
