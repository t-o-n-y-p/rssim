...
@final
class FadeAnimationsEnabledCheckboxDescriptionLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(
            logger=getLogger('root.fade_animations_enabled_checkbox_description_label'),
            i18n_resources_key='fade_animations_enabled_description_string', parent_viewport=parent_viewport
        )
