...
@final
class ScheduleOnboardingLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(
            logger=getLogger('root.schedule_onboarding_label'),
            i18n_resources_key='schedule_onboarding_page_string', parent_viewport=parent_viewport
        )
