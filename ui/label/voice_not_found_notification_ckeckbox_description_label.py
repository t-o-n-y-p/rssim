...
class VoiceNotFoundNotificationCheckboxDescriptionLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.voice_not_found_notification_checkbox_description_label'),
                         i18n_resources_key='voice_not_found_notification_description_string',
