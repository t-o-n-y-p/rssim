...
class ConstructionCompletedNotificationCheckboxDescriptionLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.construction_completed_notification_checkbox_description_label'),
