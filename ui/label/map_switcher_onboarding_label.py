...
@final
class MapSwitcherOnboardingLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(
            logger=getLogger('root.map_switcher_onboarding_label'),
            i18n_resources_key='map_switcher_onboarding_page_string', parent_viewport=parent_viewport
        )
