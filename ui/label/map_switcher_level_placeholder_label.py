...
@final
class MapSwitcherLevelPlaceholderLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(
            logger=getLogger('root.map_switcher_level_placeholder_label'),
            i18n_resources_key='unlock_condition_from_level_map_switcher_string', parent_viewport=parent_viewport
        )
        self.arguments = (0,)
