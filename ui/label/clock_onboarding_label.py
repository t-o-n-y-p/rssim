...
@final
class ClockOnboardingLabel(LocalizedLabel):
    def __init__(self, parent_viewport):
        super().__init__(
            logger=getLogger('root.clock_onboarding_label'),
            i18n_resources_key='clock_onboarding_page_string', parent_viewport=parent_viewport
        )
