...
@final
class CloseMapSwitcherButton(UIButton):
    def __init__(self, on_click_action, parent_viewport):
        super().__init__(logger=getLogger('root.button.close_map_switcher_button'), parent_viewport=parent_viewport)
    ...
    def get_position(self):
        return (
            self.parent_viewport.x2 - get_top_bar_height(self.screen_resolution),
