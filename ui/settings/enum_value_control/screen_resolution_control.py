...
class ScreenResolutionControl(EnumValueControl):
    ...
    """
    def __init__(self, column, row, possible_values_list, on_update_state_action):
        super().__init__(column, row, possible_values_list, on_update_state_action,
    ...
    def on_update_temp_value_label(self):
        ...
        """
        text = '{}x{}'.format(*self.possible_values_list[self.choice_state])
