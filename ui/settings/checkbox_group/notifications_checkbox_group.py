...
class NotificationsCheckboxGroup(CheckboxGroup):
    ...
    """
    def __init__(self, column, row, current_locale, on_update_state_actions):
        ...
        self.checkboxes \
            = [LevelUpNotificationCheckbox(column, row - 2, on_update_state_actions[0], current_locale),
               FeatureUnlockedNotificationCheckbox(column, row - 4, on_update_state_actions[1], current_locale),
               ConstructionCompletedNotificationCheckbox(column, row - 6, on_update_state_actions[2], current_locale),
               EnoughMoneyNotificationCheckbox(column, row - 8, on_update_state_actions[3], current_locale)]
