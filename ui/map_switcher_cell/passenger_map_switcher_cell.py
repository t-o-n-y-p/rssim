...
class PassengerMapSwitcherCell(MapSwitcherCell):
    def __init__(
        ...
        super().__init__(
            map_id=PASSENGER_MAP, on_buy_map_action=on_buy_map_action, on_switch_map_action=on_switch_map_action,
        ...
        self.icon_labels = [
            PassengerMapCellIcon0Label(parent_viewport=self.viewport),
