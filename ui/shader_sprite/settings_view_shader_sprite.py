...
@final
class SettingsViewShaderSprite(ShaderSprite):
    def __init__(self, view):
        super().__init__(logger=getLogger('root.app.settings.view.shader_sprite'), view=view)
    ...
    def set_uniforms(self):
        self.shader.uniforms.settings_opacity = self.view.opacity
        is_button_activated = []
        button_x = []
        button_y = []
        button_w = []
