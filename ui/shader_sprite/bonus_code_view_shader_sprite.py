...
@final
class BonusCodeViewShaderSprite(ShaderSprite):
    def __init__(self, view):
        super().__init__(logger=getLogger('root.app.bonus_code.view.shader_sprite'), view=view)
        self.shader = from_files_names('shaders/shader.vert', 'shaders/bonus_code_view/shader.frag')
    ...
    def set_uniforms(self):
        self.shader.uniforms.bonus_code_opacity = self.view.opacity
        is_button_activated = []
        button_x = []
        button_y = []
        button_w = []
