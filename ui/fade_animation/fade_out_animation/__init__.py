...
class FadeOutAnimation(FadeAnimation, ABC):
    ...
    def on_activate(self):
        ...
        self.current_fade_animation_time = (1 - self.animation_object.opacity / 255) * self.FADE_ANIMATION_TIME
        self.animation_object.on_activate()

    def on_calculate_new_opacity(self):
        return round((1 - self.current_fade_animation_time / self.FADE_ANIMATION_TIME) * 255)
