...
class FadeAnimation:
    ...
    def on_activate(self):
        ...
        self.current_opacity_chart_index = self.opacity_chart.index(self.view.opacity)
    ...
    def on_update(self):
        ...
        self.view.on_update_opacity(self.opacity_chart[self.current_opacity_chart_index])
