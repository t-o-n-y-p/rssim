...
@final
class CreateStationButtonV2(UIButtonV2):                                                                        # noqa
    @localizable_with_resource('create_station_label_string')
    def __init__(self, on_click_action, parent_viewport):
        super().__init__(logger=getLogger('root.button.create_station_button'), parent_viewport=parent_viewport)
