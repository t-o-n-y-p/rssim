...
from ui import get_bottom_bar_height, get_top_bar_height, GROUPS, BATCHES, GREEN_RGB, localizable_with_resource
...
class MapSwitcherUnlockAvailableLabelV2(LabelV2):                                                               # noqa
    ...
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.map_switcher_unlock_available_label'), parent_viewport=parent_viewport)
