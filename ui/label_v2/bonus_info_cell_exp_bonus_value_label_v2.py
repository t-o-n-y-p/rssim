...
from ui import ORANGE_RGB, BATCHES, GROUPS, get_bottom_bar_height, localizable_with_resource
...
class BonusInfoCellExpBonusValueLabelV2(LabelV2):                                                               # noqa
    ...
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.exp_bonus_value_label'), parent_viewport=parent_viewport)
