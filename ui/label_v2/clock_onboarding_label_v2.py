...
@final
class ClockOnboardingLabelV2(LabelV2):                                                                          # noqa
    @localizable_with_resource('clock_onboarding_page_string')
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.clock_onboarding_label'), parent_viewport=parent_viewport)
