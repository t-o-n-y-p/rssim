...
@final
class ShopStageLevelPlaceholderLabelV2(LabelV2):                                                                # noqa
    @localizable_with_resource('unlock_condition_from_level_shop_stage_string')
    @argument('level')
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.shop_stage_level_placeholder_label'), parent_viewport=parent_viewport)
