...
@final
class ScheduleRow12HMainLabelV2(LabelV2):                                                                       # noqa
    @localizable_with_resource('12h_schedule_row_string')
    @argument('train_id')
    @argument('12h_time')
    @argument('cars')
    def __init__(self, parent_viewport):
        super().__init__(logger=getLogger('root.schedule_row_12h_main_label'), parent_viewport=parent_viewport)
