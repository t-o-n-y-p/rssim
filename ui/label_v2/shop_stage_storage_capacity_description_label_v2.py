...
@final
class ShopStageStorageCapacityDescriptionLabelV2(LabelV2):                                                      # noqa
    @localizable_with_resource('storage_capacity_string')
    def __init__(self, parent_viewport):
        super().__init__(
            logger=getLogger('root.shop_stage_storage_capacity_description_label'), parent_viewport=parent_viewport
        )
