...
class FreightMapCrossoverController(CrossoverController):
    ...
    def create_view_and_model(self, track_param_1, track_param_2, crossover_type):
        view = FreightMapCrossoverView(
            controller=self, track_param_1=track_param_1, track_param_2=track_param_2, crossover_type=crossover_type
        )
        model = FreightMapCrossoverModel(
