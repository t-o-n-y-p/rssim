    ...
    def __init__(self, batch, bar_group, border_group):
        ...
        batch.add(28, pyglet.gl.GL_LINES, border_group,
                  ('v2i/static', (  # big generic border
                                  1, 1, self.c['graphics']['screen_resolution'][0], 1,
                                  self.c['graphics']['screen_resolution'][0], 1,
                                  self.c['graphics']['screen_resolution'][0],
                                  self.c['graphics']['screen_resolution'][1],
                                  self.c['graphics']['screen_resolution'][0],
                                  self.c['graphics']['screen_resolution'][1],
                                  1, self.c['graphics']['screen_resolution'][1],
                                  1, self.c['graphics']['screen_resolution'][1],
                                  0, 0,
                                  # big generic border layer 2
                                  2, 2, self.c['graphics']['screen_resolution'][0] - 1, 2,
                                  self.c['graphics']['screen_resolution'][0] - 1, 2,
                                  self.c['graphics']['screen_resolution'][0] - 1,
                                  self.c['graphics']['screen_resolution'][1] - 1,
                                  self.c['graphics']['screen_resolution'][0] - 1,
                                  self.c['graphics']['screen_resolution'][1] - 1,
                                  2, self.c['graphics']['screen_resolution'][1] - 1,
                                  2, self.c['graphics']['screen_resolution'][1] - 1,
                                  1, 1,
                                  # top bar border
                                  0, self.c['graphics']['screen_resolution'][1]
                                  ...
                                  self.c['graphics']['bottom_bar_width'], self.c['graphics']['bottom_bar_height'],
                                  self.c['graphics']['bottom_bar_width'], 0,
                                  # bottom bar right border
                                  self.c['graphics']['bottom_bar_width'] - 1, self.c['graphics']['bottom_bar_height'],
