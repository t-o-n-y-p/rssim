...
class TopAndBottomBar(GameObject):
    def __init__(self):
        ...
        pygame.draw.line(self.top_bar_surface, (255, 0, 0),
        ...
        pygame.draw.line(self.bottom_bar_surface, (255, 0, 0),
    ...
    def draw(self, surface, base_offset):
        ...
        surface.blit(self.bottom_bar_surface, (0, self.c['graphics']['screen_resolution'][1]
                                               - self.c['graphics']['bottom_bar_height']))
        pygame.draw.line(surface, (255, 0, 0), (0, 0), (self.c['graphics']['screen_resolution'][0] - 2, 0), 2)
        pygame.draw.line(surface, (255, 0, 0), (0, 0), (0, self.c['graphics']['screen_resolution'][1] - 2), 2)
        pygame.draw.line(surface, (255, 0, 0), (self.c['graphics']['screen_resolution'][0] - 2, 0),
                         (self.c['graphics']['screen_resolution'][0] - 2,
                          self.c['graphics']['screen_resolution'][1] - 2), 2)
        pygame.draw.line(surface, (255, 0, 0), (0, self.c['graphics']['screen_resolution'][1] - 2),
                         (self.c['graphics']['screen_resolution'][0] - 2,
                          self.c['graphics']['screen_resolution'][1] - 2), 2)
