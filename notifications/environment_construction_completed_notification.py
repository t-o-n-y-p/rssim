...
class EnvironmentConstructionCompletedNotification(Notification):
    def __init__(self, current_locale, map_id, tier):
        super().__init__(
            logger=getLogger('root.notification.environment_construction_completed_notification'),
            caption_key='environment_construction_completed_notification_caption_string',
            message_key='environment_construction_completed_notification_message_string', current_locale=current_locale,
